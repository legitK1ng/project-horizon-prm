...
const ContactHoverCard: React.FC<ContactHoverCardProps> = ({ contactName, phoneNumber, children, onContactClick }) => {
    ...
    return (
        ...
        >
            ...
            {isVisible && (
                <div
                    className="absolute z-50 left-0 top-full mt-2 w-72 bg-white dark:bg-slate-900 rounded-xl shadow-xl border border-slate-200 dark:border-slate-700 p-4 animate-in fade-in slide-in-from-top-2 duration-200"
                    onClick={(e) => { e.stopPropagation(); if (onContactClick) onContactClick(contactName); }}
                    role="button"
                    tabIndex={0}
