...
Start-Process powershell -ArgumentList "-NoExit", "-ExecutionPolicy Bypass", "-Command", "Set-Location '$BackendDir'; & '$VenvPython' horizon_supervisor.py"

# 2. Start Frontend
Write-Host "  [2/3] Starting Vite Frontend..." -ForegroundColor Green
Start-Process powershell -ArgumentList "-NoExit", "-ExecutionPolicy Bypass", "-Command", "Set-Location '$ProjectRoot'; npm run dev -- --port 3000"
